...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-28 pb-16 px-6 md:px-12 bg-gradient-to-b from-[#F8F9FC] via-[#FFFFFF] to-[#F8F9FC] overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-gradient-to-br from-[#A4C639]/10 to-transparent rounded-full blur-3xl -z-10 animate-pulse duration-[8000ms]" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[400px] h-[400px] bg-gradient-to-tr from-[#1F3C6D]/10 to-transparent rounded-full blur-3xl -z-10 animate-pulse duration-[6000ms]" />
      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-12 lg:gap-8 items-center relative">
        ...
        <div className="lg:col-span-7 space-y-8 text-left">
          {/* Tagline */}
          <div className="inline-flex items-center gap-2 bg-[#A4C639]/10 px-4 py-2 rounded-full border border-[#A4C639]/20">
            <span className="flex h-2.5 w-2.5 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#A4C639] opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2.5 w-2.5 bg-[#A4C639]"></span>
            </span>
            <span className="text-xs font-black text-[#A4C639] tracking-wider uppercase">Caravane 2026 Active</span>
          </div>

          {/* Heading */}
          <h1 className="text-5xl md:text-[5.5rem] font-black text-[#1F3C6D] leading-[1.05] tracking-tight">
            Propulser le <br className="hidden md:inline" />
            <span className="bg-gradient-to-r from-[#1F3C6D] via-[#0052a3] to-[#A4C639] bg-clip-text text-transparent">Coding Rural</span>
          </h1>
          
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-[#1F3C6D]/70 max-w-2xl leading-relaxed font-medium">
            Une plateforme tout-en-un révolutionnaire unissant <span className="text-[#A4C639] font-bold">Intelligence Artificielle</span>, 
            analyse prédictive et <span className="text-[#1F3C6D] font-bold">tracking GPS de pointe</span>. Suivez l'impact social et géolocalisé de la caravane en temps réel.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <Link 
              href="/dashboard" 
              className="px-10 py-5 bg-gradient-to-r from-[#1F3C6D] to-[#1a4b8f] text-white rounded-2xl font-bold shadow-xl shadow-[#1F3C6D]/15 hover:shadow-[#1F3C6D]/35 hover:-translate-y-1 active:translate-y-0 transition-all flex items-center justify-center gap-3 group"
            >
            ...
            <a 
              href="#stats" 
              className="px-10 py-5 bg-white text-[#1F3C6D] border border-slate-200 rounded-2xl font-bold shadow-sm hover:bg-slate-50 hover:border-slate-300 transition-all text-center flex items-center justify-center gap-2"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-6 border-t border-slate-100">
            <div>
              <p className="text-2xl font-extrabold text-[#1F3C6D]">1500+</p>
              <p className="text-xs font-semibold text-slate-400">Élèves formés</p>
            </div>
            <div>
              <p className="text-2xl font-extrabold text-[#A4C639]">98%</p>
              <p className="text-xs font-semibold text-slate-400">Taux de satisfaction</p>
            </div>
            <div className="col-span-2 md:col-span-1">
              <p className="text-2xl font-extrabold text-[#1F3C6D]">CNPD</p>
        ...
        <div className="lg:col-span-5 relative flex justify-center lg:justify-end items-center mt-12 lg:mt-0">
          ...
          <div className="relative w-80 h-[580px] bg-slate-950 rounded-[48px] p-3 shadow-2xl border-4 border-slate-800 flex flex-col justify-between overflow-hidden group hover:scale-[1.02] transition-all duration-500">
            ...
            <div className="flex-1 bg-[#F8F9FC] rounded-[38px] p-5 pt-8 flex flex-col overflow-hidden relative">
              {/* App Status bar */}
              <div className="flex justify-between items-center text-[10px] font-black text-[#1F3C6D]/50 mb-4">
                <span>09:41</span>
                <div className="flex gap-1.5 items-center">
                  <span className="w-3.5 h-2 bg-[#A4C639] rounded-sm" />
                </div>
              </div>
              ...
              <div className="flex justify-between items-center mb-6">
                <div>
                  <p className="text-[10px] font-black text-[#A4C639] uppercase tracking-wider">Formateur Terrain</p>
                  <p className="text-base font-black text-[#1F3C6D]">Youssef Alami</p>
                </div>
                <div className="w-8 h-8 rounded-lg bg-[#1F3C6D] flex items-center justify-center text-white font-extrabold text-xs">
                  YA
                </div>
              </div>
              ...
              <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100 mb-4">
                <div className="flex justify-between items-center mb-3">
                  <span className="text-xs font-black text-[#1F3C6D]">Présence GPS</span>
                ...
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-xs font-bold text-[#1F3C6D]">Lycée Al Farabi</span>
                </div>
              ...
              <div className="bg-[#0A1F44] text-white p-4 rounded-2xl shadow-sm space-y-2 mb-4">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-bold text-[#A4C639]">SmartCaravan IA</span>
                </div>
          ...
          <div className="absolute -left-16 bottom-24 bg-white/80 backdrop-blur-md p-5 rounded-2xl shadow-xl border border-white/20 w-48 hidden sm:block z-10">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-9 h-9 rounded-lg bg-[#A4C639]/10 flex items-center justify-center text-[#A4C639]">
                📈
              </div>
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase">Impact Direct</p>
                <p className="text-xs font-black text-[#1F3C6D]">Statistiques</p>
              </div>
            </div>
            <div className="space-y-1">
              <div className="flex justify-between text-[10px]">
                <span className="text-slate-400">Robots activés</span>
                <span className="font-extrabold text-[#1F3C6D]">34</span>
              </div>
              <div className="h-1 bg-slate-100 rounded-full overflow-hidden">
                <div className="w-4/5 h-full bg-[#A4C639]" />
              </div>
            </div>
          </div>
          ...
          <div className="absolute -right-8 top-16 bg-white/80 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/20 hidden sm:block z-10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-black text-[#1F3C6D]">Ifrane - 100% OK</p>
              </div>
            </div>
          </div>
