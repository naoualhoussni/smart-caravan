  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-white">
      ...
      <section id="stats" className="py-20 px-6 md:px-12 bg-slate-50 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[300px] bg-gradient-to-r from-[#A4C639]/5 to-[#1F3C6D]/5 rounded-full blur-3xl -z-10" />
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-sm font-black text-[#A4C639] tracking-widest uppercase mb-3">Statistiques Clés</h2>
            <h3 className="text-3xl md:text-5xl font-black text-[#1F3C6D] tracking-tight">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
              ...
              <p className="text-4xl font-extrabold text-[#1F3C6D] tracking-tight">45</p>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
              <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-200 inline-block">🎒</div>
              <p className="text-4xl font-extrabold text-[#A4C639] tracking-tight">1,824</p>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
              ...
              <p className="text-4xl font-extrabold text-[#1F3C6D] tracking-tight">280h</p>
            ...
            <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all group">
              <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-200 inline-block">🚚</div>
              <p className="text-4xl font-extrabold text-[#A4C639] tracking-tight">3</p>
      ...
      <section className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-sm font-black text-[#A4C639] tracking-widest uppercase mb-3">Technologie & Innovation</h2>
            <h3 className="text-3xl md:text-5xl font-black text-[#1F3C6D] tracking-tight">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="p-8 rounded-3xl border border-slate-100 hover:border-[#A4C639]/20 bg-slate-50/50 hover:bg-white transition-all shadow-sm">
              <div className="w-12 h-12 bg-[#1F3C6D]/5 rounded-2xl flex items-center justify-center text-[#1F3C6D] text-xl font-bold mb-6">
                📍
              </div>
              <h4 className="text-xl font-extrabold text-[#1F3C6D] mb-3">Validation GPS</h4>
            ...
            {/* Feature 2 */}
            <div className="p-8 rounded-3xl border border-slate-100 hover:border-[#A4C639]/20 bg-slate-50/50 hover:bg-white transition-all shadow-sm">
              <div className="w-12 h-12 bg-[#A4C639]/10 rounded-2xl flex items-center justify-center text-[#A4C639] text-xl font-bold mb-6">
                🤖
              </div>
              <h4 className="text-xl font-extrabold text-[#1F3C6D] mb-3">IA Assistant (Coach)</h4>
              <p className="text-slate-500 leading-relaxed font-medium text-sm">
            ...
            <div className="p-8 rounded-3xl border border-slate-100 hover:border-[#A4C639]/20 bg-slate-50/50 hover:bg-white transition-all shadow-sm">
              ...
              <h4 className="text-xl font-extrabold text-[#1F3C6D] mb-3">Preuves Visuelles</h4>
              <p className="text-slate-500 leading-relaxed font-medium text-sm">
            ...
            <div className="p-8 rounded-3xl border border-slate-100 hover:border-[#A4C639]/20 bg-slate-50/50 hover:bg-white transition-all shadow-sm">
              ...
              <h4 className="text-xl font-extrabold text-[#1F3C6D] mb-3">Offline-First</h4>
              <p className="text-slate-500 leading-relaxed font-medium text-sm">
            ...
            <div className="p-8 rounded-3xl border border-slate-100 hover:border-[#A4C639]/20 bg-slate-50/50 hover:bg-white transition-all shadow-sm">
              ...
              <h4 className="text-xl font-extrabold text-[#1F3C6D] mb-3">Tableau de Bord Stratégique</h4>
              <p className="text-slate-500 leading-relaxed font-medium text-sm">
            ...
            <div className="p-8 rounded-3xl border border-slate-100 hover:border-[#A4C639]/20 bg-slate-50/50 hover:bg-white transition-all shadow-sm">
              ...
              <h4 className="text-xl font-extrabold text-[#1F3C6D] mb-3">Gamification Terrain</h4>
              <p className="text-slate-500 leading-relaxed font-medium text-sm">
      ...
      <section className="py-20 px-6 md:px-12 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-sm font-black text-[#A4C639] tracking-widest uppercase mb-3">Fonctionnement</h2>
            <h3 className="text-3xl md:text-5xl font-black text-[#1F3C6D] tracking-tight">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-[#1F3C6D] text-white font-extrabold rounded-full flex items-center justify-center text-xl mx-auto shadow-lg shadow-[#1F3C6D]/20">
                1
              </div>
              <h4 className="text-lg font-bold text-[#1F3C6D]">Planifier</h4>
            ...
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-[#A4C639] text-white font-extrabold rounded-full flex items-center justify-center text-xl mx-auto shadow-lg shadow-[#A4C639]/20">
                2
              </div>
              <h4 className="text-lg font-bold text-[#1F3C6D]">Intervenir</h4>
              <p className="text-slate-400 text-sm max-w-xs mx-auto">
            ...
            <div className="text-center space-y-4">
              ...
              <h4 className="text-lg font-bold text-[#1F3C6D]">Analyser</h4>
              <p className="text-slate-400 text-sm max-w-xs mx-auto">
      ...
      <section className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-5xl mx-auto bg-gradient-to-br from-[#1F3C6D] to-[#1a4b8f] rounded-[40px] p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-[#A4C639]/20 to-transparent rounded-full blur-2xl -z-10" />
          
          <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">
            Prêt à transformer l'éducation <br /> numérique en zone rurale ?
          </h3>
          <p className="text-[#A4C639] font-bold text-lg md:text-xl max-w-2xl mx-auto mb-10 opacity-90">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/dashboard" 
              className="px-10 py-4.5 bg-[#A4C639] hover:bg-[#009685] text-white font-bold rounded-2xl shadow-lg transition-all"
            >
      ...
      <footer className="py-12 px-6 md:px-12 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <span className="text-2xl font-black text-[#1F3C6D]">SmartCaravan</span>
          <p className="text-sm font-medium text-[#1F3C6D]/50">
            © 2026 <span className="font-bold text-[#1F3C6D]">TECH-57</span>. Tous droits réservés.
          </p>
        </div>
      </footer>
    </div>
