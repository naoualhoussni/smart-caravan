...
export default function TechnicienHomePage() {
  ...
  const handleCheckIn = async (activity: any) => {
    ...
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        ...
        // Étape 1 : Récupérer le nom de l'école depuis l'activité assignée au technicien
        ...
        if (!schoolCoords) {
          ...
          // on autorise le check-in avec un avertissement (pour ne pas bloquer le technicien)
          setLocation(pos);
          setIsCheckedIn(true);
        ...
        // Étape 3 : Calcul de la distance réelle technicien ↔ établissement
  ...
  const saveBilan = async () => {
    ...
    const reportPayload = {
      ...
      trainer: profile.fullName || "Technicien IT",
      province: "Maroc",
  ...
  return (
    <>
      <div className="space-y-6 pb-24 md:pb-8">
        ...
        <div className="mt-8">
          <h2 className="text-sm font-black text-slate-400 uppercase tracking-widest mb-4">Coordination Provinciale</h2>
          ...
          <div className="bg-[#1E293B] rounded-3xl p-6 border border-white/5 space-y-6">
            <div className="flex items-center gap-4 border-b border-white/5 pb-4">
              ...
              <div>
                ...
                <p className="text-lg font-black text-white">M. Ahmed El Fassi</p>
              </div>
            </div>
